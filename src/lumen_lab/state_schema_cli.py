...
from .state_schema import MANIFEST_NAME, migrate_legacy_manifest, migration_plan, validate_state_schema
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        manifest = validate_state_schema(args.root) if (args.root / "state" / MANIFEST_NAME).exists() else None
